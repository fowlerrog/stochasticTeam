...
def generate_launch_description():
    ...
    rosflight_sim_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            'rviz2_config_file': os.path.join(uav_ugv_teaming_share, "rviz", "combined_config_plan_2.rviz")
        }.items()
    )
    ...
    # Launch second simple waypoint follower UGV
    uav_ugv_teaming_launch_2 = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(uav_ugv_teaming_share, "launch", "simple_waypoint_nav.launch.py")
        ),
        launch_arguments={
    ...
    # ghost UAV
    uav_marker_offset = Node(
        package='uav_ugv_teaming',
        executable='marker_offset',
        name='marker_offset',
        output='screen',
        parameters=[{
            'input_topic': '/rviz/mesh_scaled',
            'output_topic': '/rviz/mesh_scaled2',
            'offset_x': 1.5,
            'offset_y': 0.7,
            'offset_yaw': 1.2,
        }, param_file]
    ...
    return LaunchDescription([
        ...
        uav_pos,
        uav_vel,
        uav_ugv_teaming_launch_2,
        wheel_tf_publisher_2,
        uav_marker_offset,
    ])
