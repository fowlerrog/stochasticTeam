...
# COPIED FROM gazebo/ros_ws/install/rosflight_sim/share/rosflight_sim/launch/multirotor_standalone.launch.py
...
def generate_launch_description():
    ...
    mr_forces_moments_node = Node(
        ...
        remappings=[
            ('/sim/forces_and_moments', '/sim/forces_and_moments_collector') # THIS IS THE ONLY REASON THIS FILE EXISTS
        ]
    )
